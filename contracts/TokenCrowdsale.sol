...
contract TokenCrowdsale is TokenController, Controlled {
    ...
    uint256 constant public maximumFunding = 46000 ether;
     ...
     * @param user_address 用户地址user address
     */
